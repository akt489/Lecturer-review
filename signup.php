      ...
      <form id="signup-form" action="" method="POST">
        ...
        <div class="grid-3" style="gap: 15px; margin-bottom: 20px;">
          <div class="form-group" style="margin-bottom: 0;">
            ...
            <input type="text" id="id-number" class="form-control" required placeholder="Enter your ID number" name="id_number" value="<?php echo htmlspecialchars($idNumber); ?>">
          </div>
          <div class="form-group" style="margin-bottom: 0;">
            <label for="username">Username</label>
            <input type="text" id="username" class="form-control" required placeholder="Choose a username" name="user_name" value="<?php echo htmlspecialchars($username); ?>">
          </div>
        </div>

        <div class="form-group">
          <label for="email">Email Address</label>
          <input type="email" id="email" class="form-control" required placeholder="e.g. student@hu.edu.et" name="email" value="<?php echo htmlspecialchars($email); ?>">
        </div>
